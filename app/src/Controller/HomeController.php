...
class HomeController extends AbstractController
{
    ...
    public function index(
        ...
        return $this->render('home/index.html.twig', [
            ...
            'pending_analysis_entry_count' => $entryRepository->countPendingAnalysisEntries(),
            'relevant_without_review_count' => $entryRepository->countRelevantWithoutReview(),
            'unsynthesized_entry_count' => $entryRepository->countUnsynthesizedRelevantEntries(),
